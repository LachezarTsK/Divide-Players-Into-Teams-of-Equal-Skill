 ...
 * @return {number[]}
 */
function createFrequencySkills(skills) {
    const frequencySkills = new Array(this.RANGE_OF_SKILLS[1] + 1).fill(0);
...
/**
 * @param {number[]} frequencySkills
 * @param {number} numberOfPlayers
 * @return {number}
 */
function calculateSumOfProductsOfSkillsByDividingPlayersIntoTeamsOfTwo(frequencySkills, numberOfPlayers) {
    let left = 0;
